...
import com.shopme.product.UserProductService;
...
public class UserQuestionController {
	...
	@Autowired private UserQuestionService questionService;
	
	@Autowired private UserProductService productService;
	...
	public String listQuestionsOfProductByPage(Model model, HttpServletRequest request, @PathVariable(name = "productAlias") String productAlias,
				@PathVariable(name = "pageNum") int pageNum, String sortField, String sortDir) throws ProductNotFoundException {
		...
		long startCount = (pageNum - 1) * UserQuestionService.QUESTIONS_PER_PAGE_FOR_PUBLIC_LISTING + 1;
		model.addAttribute("startCount", startCount);
		
		long endCount = startCount + UserQuestionService.QUESTIONS_PER_PAGE_FOR_PUBLIC_LISTING - 1;
	...
	public String listQuestionsByCustomerByPage(Model model, HttpServletRequest request, @PathVariable(name = "pageNum") int pageNum,
