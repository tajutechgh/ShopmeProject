...
public class UserReviewController {
	...
	public String listReviewsByCustomerByPage(Model model, HttpServletRequest request, @PathVariable(name = "pageNum") int pageNum, 
		...
		long startCount = (pageNum - 1) * UserReviewService.REVIEWS_PER_PAGE + 1;
		model.addAttribute("startCount", startCount);
		
		long endCount = startCount + UserReviewService.REVIEWS_PER_PAGE - 1;
	...
	@GetMapping("/write-review/product/{productId}")
