...
import com.shopme.category.UserCategoryService;
...
import com.shopme.question.UserQuestionService;
import com.shopme.question.vote.QuestionVoteService;
import com.shopme.review.UserReviewService;
...
public class UserProductController {
	...
	public String viewCategoryByPage(@PathVariable("category_alias") String alias, @PathVariable("pageNum") int pageNum, Model model) {
		try {
			...
			long startCount = (pageNum - 1) * UserProductService.PRODUCTS_PER_PAGE + 1;
			long endCount = startCount + UserProductService.PRODUCTS_PER_PAGE - 1;
	...
	public String searchByPage(String keyword, @PathVariable("pageNum") int pageNum, Model model) {
		...
		long startCount = (pageNum - 1) * UserProductService.SEARCH_RESULTS_PER_PAGE + 1;
		long endCount = startCount + UserProductService.SEARCH_RESULTS_PER_PAGE - 1;
